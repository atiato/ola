        ...
        public IActionResult Post([FromBody]LoginModel loginViewModel)
        {
            ...
            JwtSecurityToken token = new JwtSecurityToken
               (
                   ...
                   signingCredentials: new SigningCredentials(new SymmetricSecurityKey(Encoding.UTF8.GetBytes("the secret that needs to be at least 16 characeters long for HmacSha256")),
