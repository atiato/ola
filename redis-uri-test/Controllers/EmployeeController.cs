...
namespace People365.EmployeeService.Controllers
{
    ...
    public class DataAccess
    {
        ...
        {
            var client = new RedisClient("redis://redis:6379?password=redis");

            List<EmployeeFilter> employees = client.Get<List<EmployeeFilter>>("Employees");

            if (employees == null)
            {
                employees = this.GetFilteredEmployeesWithTerminate(new List<string>(), new List<string>(), new List<string>(), new List<string>(),
                "15BFFEE0-4D01-44D5-B82F-84AB8695BF67", null, null, null, null, null, null, null, null, null, null, null, null, "", "", false);

                client.Add<List<EmployeeFilter>>("Employees", employees);
            }
    ...
    public class CommonDTO
    {
        ...
        {
            return "server=192.168.56.100;Password=sasql1$$;Persist Security Info=True;User ID=sa;Initial Catalog=Adir";
